...
const Footer = () => {
  return (
    <>
      <footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left font-playfair">
        ...
        <div className="mx-6 py-10 text-center md:text-center lg:text-left ">
          <div className="grid-1 grid gap-2 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className=" flex flex-col items-center lg:items-start">
              ...
              <p className="flex items-center gap-2 p-2">
                <BsClock />
                Segunda a Sexta 10:00 às 13:00 - 15:00 às 19:00
              </p>
