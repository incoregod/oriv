      ...
      <div className="px-6 py-12 text-center md:px-12 md:text-left font-playfair bg-gradient-to-b from-white via-gray-400  to-gray-50 ">
        <div className="w-100 mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl xl:px-32">
          <div className="grid items-center max-md:grid-cols-6 md:grid-cols-2 ">
            <div className="max-md:col-span-2 block rounded-lg bg-[hsla(0,0%,100%,0.55)] px-6 max-md:mt-8 py-4 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,5%,0.55)] dark:shadow-black/20 md:px-12 -mr-14 backdrop-blur-[30px]">
